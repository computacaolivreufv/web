...
function nav1(){
	var cabe = "<nav id='main_nav' class='navbar navbar-expand-lg navbar-light bg-white shadow'> <div class='container d-flex justify-content-between align-items-center'> <a class='navbar-brand h1' href='../index.html'> <span class='text-dark h4'>Computação</span> <span class='text-primary h4'>Livre</span> </a> <button class='navbar-toggler border-0' type='button' data-bs-toggle='collapse' data-bs-target='#navbar-toggler-success' aria-controls='navbarSupportedContent' aria-expanded='false' aria-label='Toggle navigation'> <span class='navbar-toggler-icon'></span> </button> <div class='align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between' id='navbar-toggler-success'> <div class='flex-fill mx-xl-5 mb-2'> <ul class='nav navbar-nav d-flex justify-content-between mx-xl-5 text-center text-dark'> <li class='nav-item'> <a class='nav-link btn-outline-primary rounded-pill px-3' href='index.html'>Início</a> </li> <li class='nav-item'> <br> </li> <li class='nav-item'> <a class='nav-link btn-outline-primary rounded-pill px-3' href='./cursos.html'>Cursos</a> </li> <li class='nav-item'> <a class='nav-link btn-outline-primary rounded-pill px-3' href='./links.html'>Links Úteis</a> </li> <li class='nav-item'> <a class='nav-link btn-outline-primary rounded-pill px-3' href='./oprojeto.html'>O projeto</a> </li> </ul> </div> <div class='navbar align-self-center d-flex'> <br> </div></div></div></nav>"; 
...
//rodapé completo
 ...
 function foot2(){ 
 	...
 	var pe = "<footer class='bg-secondary pt-4'> <div class='w-100 bg-primary py-3'> <div class='container'> <div class='row pt-2'>       <div class='col-lg-6 col-sm-12'> <p class='text-lg-start text-center text-light light-300'> © Copyright 2022 Universidade Federal de Viçosa All Rights Reserved. </p> </div> <div class='col-lg-6 col-sm-12'> <p class='text-lg-end text-center text-light light-300'> Designed Using <a rel='sponsored' class='text-decoration-none text-light' href='https://templatemo.com/' target='_blank'><strong>TemplateMo</strong></a> </p>   </div>  </div> </div> </div> </footer> ";
